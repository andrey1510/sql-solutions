...
-- 1. Write a SQL query that counts the number of unique salespeople.
...
-- 10. Find the highest purchase amount ordered by each customer on a particular date. Return order date and highest purchase amount.
